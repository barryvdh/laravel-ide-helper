...
--------------
### Added
- Add support for casts `decimal`, `encrypted:*`, `immutable_date`, `immutable_datetime`, `custom_datetime`, and `immutable_custom_datetime` [\#1258 / miken32](https://github.com/barryvdh/laravel-ide-helper/pull/1258)
