...
class Generator
{
    ...
    public function __construct(
        ...
        $this->extra = array_merge((array)$this->extra, (array)$this->config->get('ide-helper.extra'));
        $this->magic = array_merge((array)$this->magic, (array)$this->config->get('ide-helper.magic'));
        $this->interfaces = array_merge((array)$this->interfaces, (array)$this->config->get('ide-helper.interfaces'));
